...
int ADC_col(){ 
  for(side=0; side<2; side++){
    for(ch=0; ch<16; ch++){
      ...
      double baseline_col[500000]={};
      double ADC_col[500000]={};
      double rise_i[500000]={};
      double rise_f[500000]={};
      double risetime[500000]={};
	...
	//if(count % 100 == 0){
	if(1){
	  cout << "\rEvent:" << count << " " << N_all << " " << side << " " << ch;
	  fflush(stdout);
	}
      	{
	  baseline_col[i]=-1;
	...
	h_rise[side][ch] = new TH1F(hnum,hnum,80,0,160);
	for(int i=0;i<N;i++){
